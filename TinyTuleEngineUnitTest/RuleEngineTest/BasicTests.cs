...
namespace TinyRuleEngineTest.RuleEngineTest
{
    ...
    public class BasicTests
    {
        ...
        public void BasicOperatorTest()
        {
            ...
            Func<CarDTO, bool> carRule1Compiled = RuleEngine.Compile<CarDTO>(carRule1);
            Func<CarDTO, bool> carRule2Compiled = RuleEngine.Compile<CarDTO>(carRule2);
            Func<CarDTO, bool> carRule3Compiled = RuleEngine.Compile<CarDTO>(carRule3);
            Func<CarDTO, bool> carRule4Compiled = RuleEngine.Compile<CarDTO>(carRule4);
        ...
        {  
            ...
            // Compile the rules as a seperate step 
            Expression<Func<CarDTO, bool>> carRule1Exp = RuleEngine.GetExpression<CarDTO>(carRule1);
            Expression<Func<CarDTO, bool>> carRule2Exp = RuleEngine.GetExpression<CarDTO>(carRule2);
            Expression<Func<CarDTO, bool>> carRule3Exp = RuleEngine.GetExpression<CarDTO>(carRule3);
            Expression<Func<CarDTO, bool>> carRule4Exp = RuleEngine.GetExpression<CarDTO>(carRule4);
        ...
        public void StoreSomeRules()
        {
            ...
            RuleEngine.LoadRule("carrule", carRule1Exp);
            Assert.AreEqual(true, (RuleEngine.GetRule<CarDTO>("carrule").Compile()(car)),
        ...
        public void LoadFromFile()
        {
            ...
            RuleEngine.LoadRulesFromElementList<CarDTO>(xd,"/rules/rule");
            Func<CarDTO, bool> isGasGuzzler = RuleEngine.GetRule<CarDTO>("IsGasGuzzler").Compile();
